      ...
      >
        <div className="p-4 bg-white h-screen hideScrollbar overflow-y-auto">
          ...
          <ul className="space-y-4">
            {menu.map((item, index) => (
              <li key={index}>
                <div className="flex border-l-8 border-l-sidebarTheme-dark shadow-xl bg-[#fff7f7] pr-3 rounded-r-xl justify-between items-center">
                  <button
                ...
                >
                  {item.children.map((subItem, subIndex) => (
                    <li
                      className="border-l-8 border-sidebarTheme-dark rounded-r-xl shadow-xl bg-[#fff7f7] "
                      key={subIndex}
                    >
                      <button
